    ...
    return (<>
        <div className="centerContainer main-content">
            <div className="post-container edit-post-container">
                <EditLocation locationObj={locationObj} setLocationObj={setLocationObj} />
                <hr />
                <EditContent locationObj={locationObj} tagArr={tagArr} setIsEdit={setIsEdit} />
                <EditTag tag={tag} setTag={setTag} tagArr={tagArr} onClickDelTag={onClickDelTag} />
                <hr />
            </div>
        </div>
    </>)
